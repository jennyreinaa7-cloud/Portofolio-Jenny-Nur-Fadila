...
4. Bagian bawah dipisahkan oleh garis horizontal semantik menuju tajuk sebagai judul seksi, yang diikuti oleh daftar kartu kegiatan di dalam kontainer.
5. Setiap entri kegiatan dibungkus dalam elemen kontainer berkelas card yang memuat gambar dokumentasi, label kategori atau badge prestasi, judul kegiatan dalam tag serta paragraf keterangan hasil capaian.
